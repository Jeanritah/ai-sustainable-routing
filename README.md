...
urban digital twin data from the TALEA project. We aim to compute routes that
...
## Methods
- Graph-based routing
- Dijkstra / A* with custom cost functions
- Optional multi-objective optimization
